...
**Live Demo**: Upload an `.rds` or `.qs2` file (up to 20GB) to the [Demo Site](http://www.nibs.ac.cn:666/SeuratExplorer/). You can download sample demo data from [GitHub](https://github.com/fentouxungui/SeuratExplorerServer/blob/main/inst/extdata/source-data/fly/Rds-file/G101_PC20res04.rds).
...
#> [1] Seurat_5.4.0         SeuratObject_5.3.0   sp_2.2-0             SeuratExplorer_0.1.7 shiny_1.12.1        
#> 
#> loaded via a namespace (and not attached):
#>   [1] RColorBrewer_1.1-3     rstudioapi_0.17.1      jsonlite_2.0.0         magrittr_2.0.4         spatstat.utils_3.2-0   farver_2.1.2           vctrs_0.6.5           
#>   [8] ROCR_1.0-11            memoise_2.0.1          spatstat.explore_3.6-0 htmltools_0.5.9        sass_0.4.10            sctransform_0.4.2      parallelly_1.46.0     
#>  [15] KernSmooth_2.23-26     bslib_0.9.0            htmlwidgets_1.6.4      ica_1.0-3              fontawesome_0.5.3      plyr_1.8.9             plotly_4.11.0         
#>  [22] zoo_1.8-15             cachem_1.1.0           igraph_2.2.1           mime_0.13              lifecycle_1.0.4        pkgconfig_2.0.3        colourpicker_1.3.0    
#>  [29] Matrix_1.7-4           R6_2.6.1               fastmap_1.2.0          fitdistrplus_1.2-4     future_1.68.0          digest_0.6.39          patchwork_1.3.2       
#>  [36] shinycssloaders_1.1.0  tensor_1.5.1           RSpectra_0.16-2        irlba_2.3.5.1          crosstalk_1.2.2        progressr_0.18.0       spatstat.sparse_3.1-0 
#>  [43] httr_1.4.7             polyclip_1.10-7        abind_1.4-8            compiler_4.4.3         S7_0.2.1               fastDummies_1.7.5      MASS_7.3-65           
#>  [50] tools_4.4.3            lmtest_0.9-40          otel_0.2.0             httpuv_1.6.16          future.apply_1.20.1    goftest_1.2-3          glue_1.8.0            
#>  [57] nlme_3.1-168           promises_1.5.0         grid_4.4.3             Rtsne_0.17             cluster_2.1.8.1        reshape2_1.4.5         generics_0.1.4        
#>  [64] gtable_0.3.6           spatstat.data_3.1-9    shinyBS_0.63.0         tidyr_1.3.2            data.table_1.18.0      spatstat.geom_3.6-1    RcppAnnoy_0.0.22      
#>  [71] ggrepel_0.9.6          RANN_2.6.2             pillar_1.11.1          markdown_2.0           stringr_1.6.0          spam_2.11-1            RcppHNSW_0.6.0        
#>  [78] later_1.4.4            splines_4.4.3          dplyr_1.1.4            lattice_0.22-7         survival_3.8-3         deldir_2.0-4           tidyselect_1.2.1      
#>  [85] miniUI_0.1.2           pbapply_1.7-4          knitr_1.51             gridExtra_2.3          litedown_0.9           scattermore_1.2        xfun_0.55             
#>  [92] shinydashboard_0.7.3   matrixStats_1.5.0      DT_0.34.0              stringi_1.8.7          lazyeval_0.2.2         yaml_2.3.12            shinyWidgets_0.9.0    
#>  [99] evaluate_1.0.5         codetools_0.2-20       tibble_3.3.0           cli_3.6.5              uwot_0.2.4             xtable_1.8-4           reticulate_1.44.1     
#> [106] jquerylib_0.1.4        Rcpp_1.1.0             globals_0.18.0         spatstat.random_3.4-3  png_0.1-8              spatstat.univar_3.1-5  parallel_4.4.3        
#> [113] ggplot2_4.0.1          dotCall64_1.2          listenv_0.10.0         viridisLite_0.4.2      scales_1.4.0           ggridges_0.5.7         purrr_1.2.0           
#> [120] rlang_1.1.6            cowplot_1.2.0          shinyjs_2.1.0
```
